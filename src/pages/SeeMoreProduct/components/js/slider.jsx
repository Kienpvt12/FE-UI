            ...
            <div className="carousel-inner">
                <div className="carousel-item active">
                    ...
                    <div className="carousel-caption d-md-block">
                        ...
                        <p>Trong thế giới này, người ta có thể đạt được những khả năng đặc biệt bằng cách ăn trái kỹ năng chỉ một...</p>
                        <a href="#" className="btn btn-danger"><i className="fa-solid fa-play"></i> Xem Phim</a>
                    </div>
                </div>
