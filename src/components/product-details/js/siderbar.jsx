      ...
      <div className="sidebar p-3 mt-3">
        <div className="anime-update sidebar-box">
          ...
          <ul className="anime-list">
            <li>
              <a href="#">Mahoutsukai no Yakusoku</a> <span className="episode">Tập 08</span>
            </li>
            <li>
              <a href="#">Unnamed Memory 2nd Season</a> <span className="episode">Tập 08</span>
            </li>
            <li>
              <a href="#">0-saiji Start Dash Monogatari...</a> <span className="episode">Tập 08</span>
            </li>
            <li>
              <a href="#">Thần Y Cổ Đại Ở Đô Thị</a> <span className="episode">Tập 48</span>
            </li>
            <li>
              <a href="#">Thiếu Niên Ca Hành Phần 4</a> <span className="episode">Tập 09</span>
            </li>
            <li>
              <a href="#">Kiếm Đạo Đệ Nhất Tiên</a> <span className="episode">Tập 18</span>
            </li>
            <li>
              <a href="#">Ta Đã Chọc Tức Cả Đám Tu Luyện Giả</a> <span className="episode">Tập 189</span>
            </li>
            <li>
              <a href="#">Già Thiên</a> <span className="episode">Tập 08</span>
            </li>
            <li>
              <a href="#">Ta Có Thể Giác Ngộ Vô Hạn</a> <span className="episode">Tập 102</span>
            </li>
            <li>
              <a href="#">Đồ Đệ Của Ta Đều Là Đại Lão</a> <span className="episode">Tập 38</span>
            </li>
          </ul>
