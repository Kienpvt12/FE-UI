        ...
        <div className="video-container">
            ...
            <div className="episode container mt-4">
                ...
                <div className="episode-list d-flex flex-wrap gap-2">
                    ...
                    {!showAll && episodes.length > 20 && <span onClick={() => setShowAll(true)} className="more-episodes">Xem thêm tập...</span>}
                </div>
            </div>
            ...
            <div className="Movie-information container mt-4">
                <div className="information row">
                    <div className="poster-move col-md-3">
                        <img src={movie.images?.jpg?.image_url || "https://via.placeholder.com/200"} 
                        ...
                        <div className="movie-card">
                            ...
                            <p className="movie-desc">
                                ...
                                {movie.synopsis?.length > 200 && (
                                    <span className="text-white " style={{ cursor: "pointer" }} onClick={() => setShowFullDesc(!showFullDesc)}>
                            ...
                            <div className="movie-info">
                                <span><i className="fa-solid fa-clock"></i> {movie.duration || "Không rõ thời lượng"}</span>
                                <span><i className="fa-solid fa-calendar"></i> {movie.year || "Không rõ năm"}</span>
                                <span><i className="fa-solid fa-eye"></i> #{movie.popularity || "?"} trong danh sách phổ biến</span>
                            </div>
                        </div>
                    </div>
                </div>
