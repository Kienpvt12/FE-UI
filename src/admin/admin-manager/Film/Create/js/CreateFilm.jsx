        ...
        <>
            <div className="admin-main-content p-4">
                ...
                <div className="d-flex justify-content-between mb-3">
                    ...
                    <button className="btn btn-primary"><i className="fas fa-save"></i> Tạo </button>
                </div>
                ...
                <div className="card p-4 shadow-sm mt-4">
                    <ul className="nav nav-tabs mb-3">
                        <li className="nav-item">
                            <span className="nav-link active" onClick={() => navigate('/admin/create-Film')}>Thông tin phim</span>
                        </li>
                        <li className="nav-item">
                            <span className="nav-link" onClick={() => navigate('/admin/Create-Film/create-episode')} >Danh sách video phim</span>
                        </li>
                    </ul>
